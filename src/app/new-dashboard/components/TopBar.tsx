...
export function SimpleTopBar({ onMenuClick, sidebarOpen, sidebarCollapsed, onSidebarToggle }: TopBarProps) {
  ...
  return (
    <header className="bg-white/90 backdrop-blur-md border-b border-gray-200/60 sticky top-0 z-30 shadow-sm">
