            ...
            {[
              {
                ...
                description: 'Video, animasi, dan quiz interaktif untuk pembelajaran yang menarik',
              },
              {
                icon: Users,
                title: 'Kolaborasi Tim',
                description: 'Diskusi kelompok dan proyek bersama untuk pengalaman belajar kolaboratif',
              },
              {
                icon: Award,
                title: 'Sertifikat Digital',
                description: 'Sertifikat verifikasi digital yang dapat dibagikan secara online',
              },
              {
                icon: Star,
                title: 'Tracking Progress',
                description: 'Monitor perkembangan pembelajaran dengan analytics detail',
              },
            ].map((feature, index) => {
              ...
              return (
                <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden group">
                  <CardHeader className="text-center pb-4">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl mb-4 mx-auto transform group-hover:scale-110 transition-transform duration-200">
